...
Playwright: 126 specs, 689 tests (0 PW-only specs, 0 PW-only tests)

**Upstream coverage: 94%** (641/679 upstream tests found in Playwright)
...
| pages/users-and-auth | 8 | 51 | 1 | 8 | 55 | 90% |
| pages/virtualization-mgmt | 1 | 3 | 0 | 1 | 3 | ✅ |
| priority | 2 | 2 | 0 | 2 | 2 | ✅ |
| setup | 1 | 4 | 0 | 1 | 4 | ✅ |
| **TOTAL** | **127** | **679** | **58** | **126** | **689** | **94%** |
...
| pages/explorer/apps/repositories.spec.ts | 35 | 24 | 69% |
...
| pages/fleet/gitrepo.spec.ts | 28 | 10 | 36% |
| pages/fleet/helmop.spec.ts | 38 | 18 | 47% |
| pages/fleet/resources/workspaces.spec.ts | 27 | 12 | 44% |
...
| pages/manager/cluster-manager.spec.ts | 86 | 48 | 56% |
| pages/manager/edit-fake-cluster.spec.ts | 4 | 0 | 0% |
| pages/manager/hosted-providers.spec.ts | 19 | 14 | 74% |
...
| setup/rancher-setup.spec.ts | 15 | 11 | 73% |
