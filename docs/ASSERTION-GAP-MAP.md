...
Playwright: 128 specs, 703 tests (1 PW-only specs, 2 PW-only tests)

**Upstream coverage: 98%** (666/679 upstream tests found in Playwright)
...
| setup | 1 | 4 | 0 | 1 | 4 | ✅ |
| *PW-only specs* | — | — | — | 1 | 2 | — |
| **TOTAL** | **127** | **679** | **58** | **128** | **703** | **98%** |

- **Unconverted spec tests** (no PW file): 0
- **Missing by name** (PW file exists but upstream test not matched by exact name): 13
...
| pages/manager/machines.spec.ts | 7 | 5 | 71% |
