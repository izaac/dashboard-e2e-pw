...
**Upstream coverage: 91%** (601/664 upstream tests found in Playwright)
...
| pages/users-and-auth | 8 | 51 | 0 | 8 | 55 | 86% |
| pages/virtualization-mgmt | 1 | 3 | 0 | 1 | 3 | ✅ |
| priority | 2 | 2 | 0 | 2 | 2 | ✅ |
| setup | 1 | 4 | 0 | 1 | 4 | ✅ |
| **TOTAL** | **127** | **664** | **27** | **126** | **689** | **91%** |

- **Unconverted spec tests** (no PW file): 2
- **Missing by name** (PW file exists but upstream test not matched by exact name): 61
