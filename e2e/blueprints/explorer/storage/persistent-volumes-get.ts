  ...
  data: [
    {
      ...
      spec: {
        ...
        awsElasticBlockStore: { volumeID: 'volume1' },
...
export function persistentVolumesNoData(): Cypress.Chainable<Response> {
  return cy
    .intercept('GET', '/v1/persistentvolumes?*', reply(200, persistentvolumesGetResponseEmpty))
    .as('persistentvolumesNoData');
}

export function generatePersistentVolumesDataSmall(): Cypress.Chainable<Response> {
  return cy
    .intercept('GET', '/v1/persistentvolumes?*', reply(200, persistentvolumesResponseSmallSet))
    .as('persistentvolumesDataSmall');
}
