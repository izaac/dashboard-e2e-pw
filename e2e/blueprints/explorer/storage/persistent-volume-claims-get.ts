  ...
  data: [
    {
      ...
      links: {
        remove: 'https://yonasb29head.qa.rancher.space/v1/persistentvolumeclaims/cattle-system/test',
        self: 'https://yonasb29head.qa.rancher.space/v1/persistentvolumeclaims/cattle-system/test',
        update: 'https://yonasb29head.qa.rancher.space/v1/persistentvolumeclaims/cattle-system/test',
        view: 'https://yonasb29head.qa.rancher.space/api/v1/namespaces/cattle-system/persistentvolumeclaims/test',
      },
      apiVersion: 'v1',
...
export function persistentVolumeClaimsNoData(tag: string): Cypress.Chainable<Response> {
  return cy
    .intercept('GET', '/v1/persistentvolumeclaims?*', reply(200, persistentvolumeclaimsGetResponseEmpty))
    .as(tag);
}

export function generatePersistentVolumeClaimsDataSmall(tag: string): Cypress.Chainable<Response> {
  return cy
    .intercept('GET', '/v1/persistentvolumeclaims?*', reply(200, persistentvolumeclaimsResponseSmallSet))
    .as(tag);
}
