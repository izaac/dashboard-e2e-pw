...
const pstorageclassesGetResponseEmpty = {
  ...
  createTypes: {
    'storage.k8s.io.storageclass': 'https://yonasb29head.qa.rancher.space/v1/storage.k8s.io.storageclasses',
  },
  actions: {},
  ...
  data: [
    {
      ...
      links: {
        remove: 'https://yonasb29head.qa.rancher.space/v1/storage.k8s.io.storageclasses/test',
        self: 'https://yonasb29head.qa.rancher.space/v1/storage.k8s.io.storageclasses/test',
        update: 'https://yonasb29head.qa.rancher.space/v1/storage.k8s.io.storageclasses/test',
        view: 'https://yonasb29head.qa.rancher.space/apis/storage.k8s.io/v1/storageclasses/test',
      },
...
export function storageClassesNoData(): Cypress.Chainable<Response> {
  return cy
    .intercept('GET', '/v1/storage.k8s.io.storageclasses?*', reply(200, pstorageclassesGetResponseEmpty))
    .as('storageclassesNoData');
}

export function generateStorageClassesDataSmall(): Cypress.Chainable<Response> {
  return cy
    .intercept('GET', '/v1/storage.k8s.io.storageclasses?*', reply(200, storageclassesResponseSmallSet))
    .as('storageclassesDataSmall');
}
