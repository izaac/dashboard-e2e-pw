  ...
  data: [
      ...
      spec: {
        ...
        template: {
          ...
          spec: {
            containers: [
              {
                command: ['fleetcontroller', '--disable-bootstrap'],
                env: [
                  {
                    name: 'NAMESPACE',
                    valueFrom: {
    ...
    },
    {
      ...
      metadata: {
        ...
        creationTimestamp: '2023-05-29T13:32:55Z',
        fields: ['gitjob', '1/1', 1, 1, '21d', 'gitjob', 'rancher/gitjob:v0.1.54', 'app=gitjob'],
        generation: 1,
        labels: { 'app.kubernetes.io/managed-by': 'Helm' },
        managedFields: [
          {
      ...
      spec: {
        ...
        template: {
          ...
          spec: {
            containers: [
              {
                args: ['--tekton-image', 'rancher/tekton-utils:v0.1.22'],
                env: [
                  {
                    name: 'NAMESPACE',
                    valueFrom: {
        ...
        template: {
          metadata: {
            annotations: {
              ...
              'checksum/sc-dashboard-provider-config':
                'f2f0f62577145d70122067f5679acd5c1de0e5496b1481a0ea6201dfa265f930',
          ...
          spec: {
            ...
            containers: [
              ...
              {
                args: ['nginx', '-g', 'daemon off;', '-c', '/nginx/nginx.conf'],
    ...
    },
    {
      ...
      links: {
        remove:
          'https://localhost:8005/v1/apps.deployments/cattle-monitoring-system/rancher-monitoring-kube-state-metrics',
    ...
    },
    {
      ...
      links: {
        remove:
          'https://localhost:8005/v1/apps.deployments/cattle-monitoring-system/rancher-monitoring-prometheus-adapter',
