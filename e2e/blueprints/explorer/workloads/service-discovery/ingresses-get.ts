...
export const ingressesGetReponseEmpty = {
  type: 'collection',
...
export const ingressesGetResponseSmallSet = {
  type: 'collection',
  links: { self: 'https://yonasb29head.qa.rancher.space/v1/networking.k8s.io.ingresses' },
  createTypes: { 'networking.k8s.io.ingress': 'https://yonasb29head.qa.rancher.space/v1/networking.k8s.io.ingresses' },
  actions: {},
  ...
  data: [
    {
      ...
      metadata: {
        annotations: {
          'field.cattle.io/publicEndpoints':
            '[{"addresses":["18.119.127.112","3.149.240.160","52.15.149.30"],"port":443,"protocol":"HTTPS","serviceName":"cattle-system:rancher","ingressName":"cattle-system:rancher","hostname":"yonasb29head.qa.rancher.space","path":"/","allNodes":false}]',
      ...
      spec: {
        ...
        tls: [
          {
            hosts: ['yonasb29head.qa.rancher.space'],
      ...
      status: {
        loadBalancer: {
          ingress: [{ ip: '18.119.127.112' }, { ip: '3.149.240.160' }, { ip: '52.15.149.30' }],
        },
      },
    },
    {
      ...
      metadata: {
        ...
        fields: ['test', '\u003cnone\u003e', '*', '18.119.127.112,3.149.240.160,52.15.149.30', '80', '26s'],
        generation: 1,
        name: 'test',
        namespace: 'default',
        relationships: null,
