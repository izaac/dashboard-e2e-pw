...
export const servicesGetResponseSmallSet = {
  type: 'collection',
  links: { self: 'https://yonasb29.qa.rancher.space/v1/services' },
  createTypes: { service: 'https://yonasb29.qa.rancher.space/v1/services' },
  actions: {},
  ...
  data: [
    {
      ...
      metadata: {
        ...
        fields: ['rancher', 'ClusterIP', '10.43.96.35', '<none>', '80/TCP,443/TCP', '3h38m', 'app=rancher'],
        labels: {
          app: 'rancher',
    ...
    },
    {
      ...
      metadata: {
        ...
        fields: ['rancher-webhook', 'ClusterIP', '10.43.37.16', '<none>', '443/TCP', '3h32m', 'app=rancher-webhook'],
    ...
    },
    {
      ...
      metadata: {
        ...
        fields: ['kubernetes', 'ClusterIP', '10.43.0.1', '<none>', '443/TCP', '3h50m', '<none>'],
        labels: {
          component: 'apiserver',
          provider: 'kubernetes',
        },
