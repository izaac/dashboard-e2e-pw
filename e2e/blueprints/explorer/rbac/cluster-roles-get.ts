...
export const clusterRolesGetResponseEmpty = {
  ...
  createTypes: {
    'rbac.authorization.k8s.io.clusterrole':
      'https://yonasb29h3.qa.rancher.space/v1/rbac.authorization.k8s.io.clusterroles',
  },
  actions: {},
...
export const clusterRolesResponseSmallSet = {
  type: 'collection',
  links: { self: 'https://yonasb29h3.qa.rancher.space/v1/rbac.authorization.k8s.io.clusterroles' },
  createTypes: {
    'rbac.authorization.k8s.io.clusterrole':
  ...
  data: [
    {
      ...
      aggregationRule: {
        clusterRoleSelectors: [{ matchLabels: { 'rbac.authorization.k8s.io/aggregate-to-admin': 'true' } }],
      },
      ...
      metadata: {
        ...
        fields: ['admin', '2024-07-08T22:02:18Z'],
        finalizers: ['wrangler.cattle.io/auth-prov-v2-crole'],
    ...
    },
    {
      ...
      kind: 'ClusterRole',
      metadata: {
        annotations: { 'meta.helm.sh/release-name': 'rke2-canal', 'meta.helm.sh/release-namespace': 'kube-system' },
        creationTimestamp: '2024-07-08T22:03:01Z',
        fields: ['calico-node', '2024-07-08T22:03:01Z'],
        finalizers: ['wrangler.cattle.io/auth-prov-v2-crole'],
