...
export const clusterRoleBindingGetResponseEmpty = {
  ...
  createTypes: {
    'rbac.authorization.k8s.io.clusterrolebinding':
      'https://yonasb29head.qa.rancher.space/v1/rbac.authorization.k8s.io.clusterrolebindings',
  },
  actions: {},
...
export const clusterRoleBindingResponseSmallSet = {
  type: 'collection',
  links: { self: 'https://yonasb29head.qa.rancher.space/v1/rbac.authorization.k8s.io.clusterrolebindings' },
  createTypes: {
    'rbac.authorization.k8s.io.clusterrolebinding':
  ...
  data: [
    {
      ...
      metadata: {
        ...
        fields: ['aks-operator', 'ClusterRole/aks-operator', '8d', '', '', 'cattle-system/aks-operator'],
        finalizers: ['wrangler.cattle.io/auth-prov-v2-crb'],
      ...
      roleRef: { apiGroup: 'rbac.authorization.k8s.io', kind: 'ClusterRole', name: 'aks-operator' },
      subjects: [{ kind: 'ServiceAccount', name: 'aks-operator', namespace: 'cattle-system' }],
    },
    {
      id: 'canal-calico',
      type: 'rbac.authorization.k8s.io.clusterrolebinding',
      ...
      metadata: {
        ...
        fields: ['canal-calico', 'ClusterRole/calico-node', '9d', '', '', 'kube-system/canal'],
        finalizers: ['wrangler.cattle.io/auth-prov-v2-crb'],
        labels: { 'app.kubernetes.io/managed-by': 'Helm' },
        name: 'canal-calico',
        relationships: [
      ...
      roleRef: { apiGroup: 'rbac.authorization.k8s.io', kind: 'ClusterRole', name: 'calico-node' },
      subjects: [{ kind: 'ServiceAccount', name: 'canal', namespace: 'kube-system' }],
    },
  ],
};
