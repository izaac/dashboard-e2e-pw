const res = {
  ...
  sort: {
    ...
    links: {
      ...
      name: 'https://localhost:8005/v3/principals?sort=name',
      principalType: 'https://localhost:8005/v3/principals?sort=principalType',
      profilePicture: 'https://localhost:8005/v3/principals?sort=profilePicture',
      profileURL: 'https://localhost:8005/v3/principals?sort=profileURL',
      provider: 'https://localhost:8005/v3/principals?sort=provider',
      uuid: 'https://localhost:8005/v3/principals?sort=uuid',
    },
  },
  filters: {
    created: null,
...
export function spoofThirdPartyPrincipal(): Cypress.Chainable<Response> {
  return cy
    .intercept('GET', '/v3/principals', (req) => {
      req.reply({
        statusCode: 200,
        body: res,
      });
