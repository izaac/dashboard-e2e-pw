export const mockCapiProvCluster = {
  ...
  links: {
    patch: 'https://localhost:8005/v1/provisioning.cattle.io.clusters/fleet-default/mocked-capi',
    remove: 'https://localhost:8005/v1/provisioning.cattle.io.clusters/fleet-default/mocked-capi',
    self: 'https://localhost:8005/v1/provisioning.cattle.io.clusters/fleet-default/mocked-capi',
    update: 'https://localhost:8005/v1/provisioning.cattle.io.clusters/fleet-default/mocked-capi',
    view: 'https://localhost:8005/apis/provisioning.cattle.io/v1/namespaces/fleet-default/clusters/mocked-capi',
  },
  apiVersion: 'provisioning.cattle.io/v1',
  kind: 'Cluster',
  metadata: {
    annotations: {
      'field.cattle.io/creatorId': 'user-br7cj',
      'objectset.rio.cattle.io/applied':
        '',
      'objectset.rio.cattle.io/id': '5fff76da-65e6-4dd3-a0c1-5002efc59675',
      'provisioning.cattle.io/management-cluster-display-name': 'mocked-capi',
    },
    ...
    relationships: [
      {
        toId: 'fleet-default/r-cluster-mocked-capi-view-c-m-h7mt5x6v-p-b2bct-creator-pr-3ba2c',
      ...
      {
        toId: 'fleet-default/crt-mocked-capi-nodes-manage',
      ...
      },
      {
        ...
        rel: 'applies',
        state: 'updating',
        message: 'configuring control plane node(s) mocked-capi-ctrl-7ppvs-7cqst,mocked-capi-ctrl-7ppvs-rbj9n',
        transitioning: true,
      },
      {
        toId: 'fleet-default/mocked-capi',
        toType: 'cluster.x-k8s.io.cluster',
        rel: 'owner',
        state: 'provisioned',
      },
      {
        toId: 'fleet-default/r-cluster-mocked-capi-view-c-m-h7mt5x6v-p-qkjlg-creator-pr-26063',
        toType: 'rbac.authorization.k8s.io.rolebinding',
        rel: 'owner',
        state: 'active',
        message: 'Resource is current',
      ...
      {
        toId: 'fleet-default/r-cluster-mocked-capi-view',
        toType: 'rbac.authorization.k8s.io.role',
        rel: 'owner',
        state: 'active',
        message: 'Resource is current',
      ...
      machinePools: [
        ...
        },
        {
          ...
          machineConfigRef: {
            apiVersion: 'infrastructure.cluster.x-k8s.io/v1beta2',
            kind: 'AWSMachineTemplate',
            name: 'mocked-capi-control-plane',
            namespace: 'fleet-default',
          },
          name: 'ctrl',
          quantity: 2,
      ...
      machineSelectorFiles: [
        {
          fileSources: [
            {
              configMap: {
                items: [{ key: 'extra-config.yaml', path: '/etc/rancher/rke2/config.yaml.d/extra-config.yaml' }],
                name: 'mocked-capi-extra-config',
              },
              secret: { name: '' },
            },
          ],
  ...
  status: {
    ...
    conditions: [
      {
        error: false,
        lastUpdateTime: '2026-02-19T19:12:57Z',
        reason: 'Reconciling',
        status: 'True',
        transitioning: true,
        type: 'Reconciling',
      ...
      {
        error: false,
        lastUpdateTime: '2026-02-19T19:13:05Z',
        status: 'True',
        transitioning: false,
        type: 'Created',
      },
      {
        error: false,
        lastUpdateTime: '2026-02-19T19:17:25Z',
        status: 'True',
        transitioning: false,
        type: 'RKECluster',
      },
      ...
      {
        error: false,
        lastUpdateTime: '2026-02-19T19:12:58Z',
        status: 'True',
        transitioning: false,
      ...
      {
        error: false,
        lastUpdateTime: '2026-02-19T19:12:59Z',
        status: 'True',
        transitioning: false,
      ...
      {
        error: false,
        lastUpdateTime: '2026-02-19T19:13:02Z',
        status: 'True',
        transitioning: false,
        type: 'NoDiskPressure',
      },
      ...
      {
        error: false,
        lastUpdateTime: '2026-02-19T19:13:04Z',
        status: 'False',
        transitioning: false,
        type: 'Connected',
      },
...
export const mockCapiMgmtCluster = {
  ...
  links: {
    log: 'https://localhost:8005/v1/management.cattle.io.clusters/c-m-h7mt5x6v?link=log',
    patch: 'blocked',
    projects: 'https://localhost:8005/v1/management.cattle.io.clusters/c-m-h7mt5x6v?link=projects',
    remove: 'blocked',
    schemas: 'https://localhost:8005/v1/management.cattle.io.clusters/c-m-h7mt5x6v?link=schemas',
    self: 'https://localhost:8005/v1/management.cattle.io.clusters/c-m-h7mt5x6v',
    shell: 'wss://localhost:8005/v3/clusters/c-m-h7mt5x6v?shell=true',
    subscribe: 'https://localhost:8005/v1/management.cattle.io.clusters/c-m-h7mt5x6v?link=subscribe',
    update: 'blocked',
    view: 'https://localhost:8005/v1/management.cattle.io.clusters/c-m-h7mt5x6v',
  },
  actions: {
    apply: 'https://localhost:8005/v1/management.cattle.io.clusters/c-m-h7mt5x6v?action=apply',
    generateKubeconfig: 'https://localhost:8005/v3/clusters/c-m-h7mt5x6v?action=generateKubeconfig',
    importYaml: 'https://localhost:8005/v3/clusters/c-m-h7mt5x6v?action=importYaml',
  },
  ...
  metadata: {
    ...
    relationships: [
      {
        fromId: 'fleet-default/mocked-capi',
      ...
      {
        toId: 'c-m-h7mt5x6v-clusterowner',
      ...
      {
        toId: 'c-m-h7mt5x6v-clustermember',
        toType: 'rbac.authorization.k8s.io.clusterrole',
        rel: 'owner',
        state: 'active',
        message: 'Resource is current',
  ...
  spec: {
    ...
    clusterSecrets: {},
    description: '',
    desiredAgentImage: 'rancher/rancher-agent:v2.14-101bf122357709bede8f96d8f94c756b4c4b69bb-head',
    desiredAuthImage: 'rancher/kube-api-auth:v0.2.5',
    displayName: 'mocked-capi',
  ...
  status: {
    ...
    conditions: [
      ...
      {
        error: false,
        lastUpdateTime: '2026-02-19T19:15:41Z',
        status: 'True',
        transitioning: false,
        type: 'Provisioned',
      },
      {
        error: true,
        lastUpdateTime: '2026-02-19T19:15:49Z',
