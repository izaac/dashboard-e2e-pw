  ...
  return [
    {
      ...
      metadata: {
        annotations: {
          'cattle.io/status':
            '{"Conditions":[{"Type":"ResourceQuotaInit","Status":"True","Message":"","LastUpdateTime":"2024-03-07T15:52:00Z"},{"Type":"InitialRolesPopulated","Status":"True","Message":"","LastUpdateTime":"2024-03-07T15:52:05Z"}]}',
        ...
        fields: ['calico-system', 'Active', '20h'],
        labels: {
    ...
    },
    {
      ...
      metadata: {
        annotations: {
          'cattle.io/status':
            '{"Conditions":[{"Type":"ResourceQuotaInit","Status":"True","Message":"","LastUpdateTime":"2024-03-07T15:52:49Z"},{"Type":"InitialRolesPopulated","Status":"True","Message":"","LastUpdateTime":"2024-03-07T15:52:54Z"}]}',
          'field.cattle.io/projectId': `${mgmtClusterId}:p-jwd4v`,
          'lifecycle.cattle.io/create.namespace-auth': 'true',
          'management.cattle.io/no-default-sa-token': 'true',
          'objectset.rio.cattle.io/applied':
            'H4sIAAAAAAAA/3zOzW3DMAyG4V14jt3EahNbc3QBSqIaFfoxzC+HwvDuhep7byQIPC93KgIODCa7E9fawEital+b+xYPFYxbaqNnIMuY2lsKZClmEQz8JRWDaw2KjVc6LuQ3+SM+UxEFl5VsfeV8ocxO8r/wk/XZabMs4erM7RpddNMsy/3+MLcpBv9gY5aPd5nc7Odeq1yELJ3GcD6lPwop/aqreLJ7n8B49fhx/AYAAP//76piwPQAAAA',
          'objectset.rio.cattle.io/id': 'fleet-agent-bootstrap',
        },
        creationTimestamp: '2024-03-07T15:52:47Z',
        fields: ['cattle-fleet-system', 'Active', '20h'],
    ...
    },
    {
      ...
      metadata: {
        annotations: {
          'cattle.io/status':
            '{"Conditions":[{"Type":"ResourceQuotaInit","Status":"True","Message":"","LastUpdateTime":"2024-03-07T15:52:01Z"},{"Type":"InitialRolesPopulated","Status":"True","Message":"","LastUpdateTime":"2024-03-07T15:52:06Z"}]}',
          'field.cattle.io/projectId': `${mgmtClusterId}:p-jwd4v`,
          'lifecycle.cattle.io/create.namespace-auth': 'true',
          'management.cattle.io/no-default-sa-token': 'true',
        },
        creationTimestamp: '2024-03-07T15:51:59Z',
        fields: ['cattle-impersonation-system', 'Active', '20h'],
        finalizers: ['controller.cattle.io/namespace-auth'],
        labels: {
    ...
    },
    {
      ...
      metadata: {
        ...
        fields: ['cattle-system', 'Active', '20h'],
        finalizers: ['controller.cattle.io/namespace-auth'],
        labels: {
          'field.cattle.io/projectId': 'p-jwd4v',
    ...
    },
    {
      ...
      metadata: {
        annotations: {
          'cattle.io/status':
            '{"Conditions":[{"Type":"ResourceQuotaInit","Status":"True","Message":"","LastUpdateTime":"2024-03-07T15:52:00Z"},{"Type":"InitialRolesPopulated","Status":"True","Message":"","LastUpdateTime":"2024-03-07T15:52:06Z"}]}',
          'field.cattle.io/projectId': `${mgmtClusterId}:p-rs8ps`,
          'lifecycle.cattle.io/create.namespace-auth': 'true',
        },
        creationTimestamp: '2024-03-07T15:48:53Z',
        fields: ['default', 'Active', '20h'],
        finalizers: ['controller.cattle.io/namespace-auth'],
        labels: {
    ...
    },
    {
      ...
      metadata: {
        ...
        creationTimestamp: '2024-03-07T15:48:53Z',
        fields: ['kube-node-lease', 'Active', '20h'],
        finalizers: ['controller.cattle.io/namespace-auth'],
        labels: {
          'field.cattle.io/projectId': 'p-jwd4v',
    ...
    },
    {
      ...
      metadata: {
        annotations: {
          'cattle.io/status':
            '{"Conditions":[{"Type":"ResourceQuotaInit","Status":"True","Message":"","LastUpdateTime":"2024-03-07T15:52:17Z"},{"Type":"InitialRolesPopulated","Status":"True","Message":"","LastUpdateTime":"2024-03-07T15:52:17Z"}]}',
          'lifecycle.cattle.io/create.namespace-auth': 'true',
        },
        creationTimestamp: '2024-03-07T15:52:16Z',
        fields: ['local', 'Active', '20h'],
        finalizers: ['controller.cattle.io/namespace-auth'],
    ...
    },
    {
      ...
      metadata: {
        ...
        fields: ['tigera-operator', 'Active', '20h'],
        finalizers: ['controller.cattle.io/namespace-auth'],
        labels: {
...
function generateFakeNavClusterData(
  provClusterId = 'some-prov-cluster-id',
  mgmtClusterId = 'some-mgmt-cluster-id',
...
export function generateFakeClusterDataAndIntercepts({
  ...
  const fakeNavClusterData = generateFakeNavClusterData(
    fakeProvClusterId,
    fakeMgmtClusterId,
    addEditClusterCapabilities,
  );
