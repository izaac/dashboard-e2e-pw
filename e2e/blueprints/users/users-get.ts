  ...
  data: [
    {
      actions: {
        refreshauthprovideraccess:
          'https://yonasb29h3.qa.rancher.space/v3/users/u-mvhtt?action=refreshauthprovideraccess',
      ...
      links: {
        clusterRoleTemplateBindings:
          'https://yonasb29h3.qa.rancher.space/v3/clusterRoleTemplateBindings?userId=u-mvhtt',
        globalRoleBindings: 'https://yonasb29h3.qa.rancher.space/v3/globalRoleBindings?userId=u-mvhtt',
        projectRoleTemplateBindings:
          'https://yonasb29h3.qa.rancher.space/v3/projectRoleTemplateBindings?userId=u-mvhtt',
    ...
    },
    {
      actions: {
        refreshauthprovideraccess:
          'https://yonasb29h3.qa.rancher.space/v3/users/user-4g8mm?action=refreshauthprovideraccess',
      ...
      links: {
        clusterRoleTemplateBindings:
          'https://yonasb29h3.qa.rancher.space/v3/clusterRoleTemplateBindings?userId=user-4g8mm',
        globalRoleBindings: 'https://yonasb29h3.qa.rancher.space/v3/globalRoleBindings?userId=user-4g8mm',
        projectRoleTemplateBindings:
          'https://yonasb29h3.qa.rancher.space/v3/projectRoleTemplateBindings?userId=user-4g8mm',
...
export async function generateUsersDataSmall(page: Page): Promise<void> {
  await page.route('**/v1/management.cattle.io.users?*', (route) =>
    route.fulfill({ status: 200, contentType: 'application/json', body: JSON.stringify(usersGetResponseSmallSet) }),
  );
}
