...
211 Page Objects indexed.

## components/

| Class | File | Extends | Selector | Methods |
|-------|------|---------|----------|---------|
| ACE | ace.po.ts | ComponentPo | — | super, enabledRadio, enable, fqdn, caCerts, enterFdqn, enterCaCerts |
...
| HeaderPo | header.po.ts | ComponentPo | `[data-testid=` | super, projectNamespaceFilter, selectNamespaceFilterOption, selectWorkspace, workspaceSwitcher, importYamlHeaderAction, importYaml, kubectlShell (+10) |
...
| TooltipPo | tooltip.po.ts | ComponentPo | `:scope` | super, show, content |
...
| NodeSchedulingPo | node-scheduling.po.ts | ComponentPo | — | super, selectNodeRadio, selectAnyNode, selectSpecificNode, selectSchedulingRules, radioOption, nodeSelector |
...
| Class | File | Extends | Selector | Methods |
|-------|------|---------|----------|---------|
| ClusterManagerDetailHostedPagePo | cluster-detail-hosted.po.ts | ClusterManagerDetailPagePo | — | resourceDetail, nodePoolTable, groupByPoolToolTip, flatListToolTip |
| ClusterManagerDetailImportedGenericPagePo | cluster-detail-import-generic.po.ts | ClusterManagerDetailPagePo | — | — |
...
| ClusterManagerDetailRke2CustomPagePo | cluster-detail-rke2-custom.po.ts | ClusterManagerDetailPagePo | — | — |
| ClusterManagerDetailPagePo | cluster-detail.po.ts | PagePo | — | super, title, openShowConfiguration, detailDrawer, logsContainer, kubectlCommandForImported, poolsList, conditionsTable (+6) |
...
| AzureCloudCredentialsCreateEditPo | cloud-credentials-azure.po.ts | PagePo | — | super, nameNsDescription, environment, subscriptionId, clientId, clientSecret, saveCreateForm, saveButton (+1) |
...
| GKECloudCredentialsCreateEditPo | cloud-credentials-gke.po.ts | PagePo | — | super, nameNsDescription, serviceAccount, authenticateButton, saveCreateForm, saveButton |
...
## edit/provisioning.cattle.io.cluster/
...
| ClusterManagerCreateRke2AzurePagePo | cluster-create-rke2-azure.po.ts | ClusterManagerCreatePagePo | — | super, basicsTab, nameNsDescription, azureEnvironmentSelect, azureEnvironmentDropdownToggle, azureDropdownOption, subscriptionIdInput, clientIdInput (+9) |
| ClusterManagerCreateRke2CustomPagePo | cluster-create-rke2-custom.po.ts | ClusterManagerCreatePagePo | — | super, goToCustomClusterCreation, goToDigitalOceanCreation, title, clusterConfigurationTabs, registries, nameNsDescription, resourceDetail (+6) |
...
| ClusterManagerEditRke2CustomPagePo | cluster-edit-rke2-custom.po.ts | ClusterManagerCreateImportPagePo | — | super, clusterConfigurationTabs, calicoAddonConfig |

## edit/provisioning.cattle.io.cluster/import/

| Class | File | Extends | Selector | Methods |
|-------|------|---------|----------|---------|
| ClusterManagerImportPagePo | cluster-import.po.ts | ClusterManagerCreateImportPagePo | — | super, selectKubeProvider, selectGeneric |
...
| ProjectSecretsListPagePo | project-secrets.po.ts | PagePo | — | super, title, createButton, list, cruResource, selectSecretSubtype, projectSelect, nameNsDescription (+3) |
...
| ServicesPagePo | services.po.ts | PagePo | — | super, list, clickCreate, mastheadTitle, nameNsDescription, nameInput, descriptionInput, formSave (+7) |
...
| Class | File | Extends | Selector | Methods |
|-------|------|---------|----------|---------|
| WorkloadDashboardPagePo | workload-dashboard.po.ts | PagePo | `/c/${clusterId}/explorer/workload-dashboard` | super, masthead, title, subtitle, byStateSection, stateCards, byTypeSection, byTypeCards (+3) |
...
| Class | File | Extends | Selector | Methods |
|-------|------|---------|----------|---------|
| BurgerMenuPo | burger-side-menu.po.ts | ComponentPo | `[data-testid=` | super, toggle, isOpen, open, if, burgerMenuNavToMenuByLabel, burgerMenuNavToClusterByLabel, clusterKeyComboIcon (+31) |
