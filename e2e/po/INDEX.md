...
| AsyncButtonPo | async-button.po.ts | ComponentPo | — | click, expectToBeDisabled, expectToBeEnabled, waitForDisabledAppearanceToDisappear, label, action, apply |
...
| ColorInputPo | color-input.po.ts | — | — | self, value, return, previewColor, set |
| ComponentPo | component.po.ts | — | — | self, if, testId, isDisabled, checkVisible, checkNotVisible, checkExists, checkNotExists (+2) |
| CreateEditViewPo | create-edit-view.po.ts | ComponentPo | — | nameNsDescription, errorBanner, createButton, create, save, cancel, saveAndWait, nextPage (+4) |
...
| PasswordPo | password.po.ts | ComponentPo | — | set, showBtn |
...
| Class | File | Extends | Selector | Methods |
|-------|------|---------|----------|---------|
| LoggingPo | logging.po.ts | ComponentPo | `.dashboard-root` | super, mastheadCreate, nameInput, formSave, outputTargetInput, outputsTab, matchTab, flowOutputSelector (+5) |
...
| Class | File | Extends | Selector | Methods |
|-------|------|---------|----------|---------|
| AboutPagePo | about.po.ts | PagePo | — | super, diagnosticsBtn |
...
| HomePagePo | home.po.ts | PagePo | — | super, goTo, navTo, title, whatsNewBannerLink, list, manageButton, importExistingButton (+9) |
| LoginPagePo | login-page.po.ts | PagePo | — | super, goTo, username, password, canSubmit, submit, switchToLocal, if (+5) |
| PagePo | page.po.ts | ComponentPo | — | super, goTo, waitForPage, waitForPageWithExactUrl, waitForUrlPathWithoutContext, isCurrentPage, if, checkIsCurrentPage (+11) |
| PreferencesPagePo | preferences.po.ts | PagePo | — | super, title, themeOptions, dateFormatSelect, timeFormatSelect, perPageSelect, scalingDownPromptCheckbox, viewInApiCheckbox (+8) |
...
| InstallChartPage | install-charts.po.ts | PagePo | `/c/${clusterId}/apps/charts/install` | super, waitForChartPage, nextPage, installChart, editYaml, editOptions, selectTab, chartName (+4) |
...
| Class | File | Extends | Selector | Methods |
|-------|------|---------|----------|---------|
| BannerCheckboxPo | banners.po.ts | — | — | self, set, ensureChecked, if, isChecked, checkVisible, hasAppropriateWidth, expect (+29) |
| BrandingPagePo | branding.po.ts | RootClusterPage | — | super, privateLabel, saveButton |
