...
| Class | File | Extends | Selector | Methods |
|-------|------|---------|----------|---------|
| ChartRepositoriesCreateEditPo | chart-repositories.po.ts | PagePo | — | super, nameNsDescription, gitRepoUrl, gitBranch, ociUrl, helmUrlInput, ociUrlInput, ociCaBundleInput (+22) |
...
| Class | File | Extends | Selector | Methods |
|-------|------|---------|----------|---------|
| ClusterManagerCreateAKSPagePo | cluster-create-aks.po.ts | ClusterManagerCreatePagePo | — | super, resourceDetail, cloudCredentialsForm, clusterNameInput, getClusterName, getClusterDescription, clusterResourceGroup, dnsPrefixInput (+3) |
...
| ServicesPagePo | services.po.ts | PagePo | — | super, list, clickCreate, mastheadTitle, nameNsDescription, nameInput, descriptionInput, formSave (+5) |
