...
| ClusterManagerCreateRke2AzurePagePo | cluster-create-rke2-azure.po.ts | ClusterManagerCreatePagePo | — | super, nameNsDescription, saveButton, createButton, azureEnvironmentSelect, azureDropdownOption, subscriptionIdInput, clientIdInput (+8) |
...
| StorageClassesPagePo | storage-classes.po.ts | PagePo | — | super, urlPath, list, listElementWithName, clickCreate, yamlEditor, createStorageClassesForm |
| UiPluginsPagePo | uiplugins.po.ts | PagePo | — | super, resourceTable, cacheState, goToDetailsPage, clickCreate, createPath |
| WorkloadsDaemonsetsListPagePo | workloads-daemonsets.po.ts | PagePo | — | super, baseResourceList, redeployDialog, resourceDetail, containerImageInput, clickTab, daemonSetTab, upgradingTab (+2) |
| WorkloadsStatefulSetsListPagePo | workloads-statefulsets.po.ts | PagePo | — | super, redeployDialog |
...
| WorkloadsListPageBasePo | workloads.po.ts | PagePo | `${urlStr}${params}` | super, sortableTable, listElementWithName, goToEditYamlPage, goToEditConfigPage, deleteItemWithUI, nameInput, selectNamespace (+15) |
