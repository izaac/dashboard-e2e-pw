    ...
    data: [
      {
        ...
        links: {
          remove: 'blocked',
          self: `/v1/management.cattle.io.nodedrivers/${driver}`,
          update: 'blocked',
          view: `/v1/management.cattle.io.nodedrivers/${driver}`,
        },
        ...
        spec: {
          ...
          addCloudCredential,
          builtin: false,
          checksum: '65dbf92e2df2b4c6d1a6b1f77c542f2cb13a052a62f236eeee697a1151ede62c',
          description: '',
          displayName: driver,
          externalId: '',
          uiUrl: `https://${driver}.github.io/rancher-ui-driver/v3.4.0/component.js`,
          url: `https://github.com/${driver}/docker-machine/releases/download/v3.4.0/docker-machine-driver-${driver}`,
          whitelistDomains: [`${driver}.github.io`],
        },
        status: {
          ...
          conditions: [
            {
              error: false,
              lastUpdateTime: '2024-02-02T22:14:36Z',
              status: 'True',
              transitioning: false,
              type: 'Active',
            },
            {
              error: false,
              lastUpdateTime: '2024-01-26T18:32:58Z',
              status: 'True',
              transitioning: false,
              type: 'Inactive',
            },
            {
              error: false,
              lastUpdateTime: '2024-02-02T22:14:26Z',
              status: 'True',
              transitioning: false,
              type: 'Downloaded',
            },
